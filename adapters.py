...
def plain(problem, budget=1000, sigma0=0.1, adapt=True, seed=None, print_every=0, **kwargs) -> Any:
    ...
    from algorithms.one_plus_one_es import one_plus_one_es
...
def self(problem, budget=1000, sigma0=0.1, seed=None, print_every=0, **kwargs) -> Any:
    ...
    from algorithms.one_plus_one_self_adaptive import one_plus_one_self_adaptive
...
def combo(problem, budget=1000, sigma0=0.1, seed=None, print_every=0, mirrored=True, reevaluate_k=3, restart_no_improve=200, **kwargs) -> Any:
    ...
    from algorithms.one_plus_one_combo import one_plus_one_combo
...
def rand2(problem, budget=1000, pop_size=30, F=0.8, CR=0.9, seed=None, print_every=0, **kwargs) -> Any:
    ...
    from algorithms.differential_evolution_rand2 import differential_evolution_rand2
...
def rand_to_best2(problem, budget=1000, pop_size=30, F=0.8, CR=0.9, seed=None, print_every=0, **kwargs) -> Any:
    ...
    from algorithms.differential_evolution_rand_to_best2 import differential_evolution_rand_to_best2
...
def best1(problem, budget=1000, pop_size=30, F=0.8, CR=0.9, seed=None, print_every=0, **kwargs) -> Any:
    ...
    from algorithms.differential_evolution_best1 import differential_evolution_best1
...
def best2(problem, budget=1000, pop_size=30, F=0.8, CR=0.9, seed=None, print_every=0, **kwargs) -> Any:
    ...
    from algorithms.differential_evolution_best2 import differential_evolution_best2
...
def current_to_best1(problem, budget=1000, pop_size=30, F=0.8, CR=0.9, seed=None, print_every=0, **kwargs) -> Any:
    ...
    from algorithms.differential_evolution_current_to_best1 import differential_evolution_current_to_best1
...
def adaptive_de(problem, budget=1000, pop_size=30, F=0.8, CR=0.9, seed=None, print_every=0, **kwargs) -> Any:
    ...
    from algorithms.adaptive_differential_evolution import adaptive_differential_evolution
...
def adaptive_mixed_de(problem, budget=1000, pop_size=30, F=0.8, CR=0.9, seed=None, print_every=0, **kwargs) -> Any:
    ...
    from algorithms.adaptive_mixed_de import adaptive_mixed_de as _amd
